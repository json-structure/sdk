...
export const INSTANCE_CHOICE_MISSING_OPTIONS = "INSTANCE_CHOICE_MISSING_OPTIONS";

/** Choice discriminator property is missing. */
export const INSTANCE_CHOICE_DISCRIMINATOR_MISSING = "INSTANCE_CHOICE_DISCRIMINATOR_MISSING";

/** Discriminator value must be a string. */
export const INSTANCE_CHOICE_DISCRIMINATOR_NOT_STRING = "INSTANCE_CHOICE_DISCRIMINATOR_NOT_STRING";

/** Unknown choice option. */
export const INSTANCE_CHOICE_OPTION_UNKNOWN = "INSTANCE_CHOICE_OPTION_UNKNOWN";
...
export const ErrorCodes = {
  ...
  INSTANCE_CHOICE_MISSING_OPTIONS,
  INSTANCE_CHOICE_DISCRIMINATOR_MISSING,
  INSTANCE_CHOICE_DISCRIMINATOR_NOT_STRING,
  INSTANCE_CHOICE_OPTION_UNKNOWN,
