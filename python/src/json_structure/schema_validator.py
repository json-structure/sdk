...
class JSONStructureSchemaCoreValidator:
    ...
    KNOWN_EXTENSIONS = {
        ...
        "JSONStructureRelations", "JSONStructureSemanticAnnotations"
    }
    ...
    def _check_enabled_extensions(self, doc):
        ...
        # The semantic-annotations meta-schema enables the extensions it declares in $uses
        if "semantic-annotations" in schema_uri:
            self.enabled_extensions.add("JSONStructureUnits")
            self.enabled_extensions.add("JSONStructureImport")
            self.enabled_extensions.add("JSONStructureConditionalComposition")
            self.enabled_extensions.add("JSONStructureValidation")
            self.enabled_extensions.add("JSONStructureSemanticAnnotations")
